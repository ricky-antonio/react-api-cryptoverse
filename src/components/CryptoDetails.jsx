...
import {
	MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, ExclamationCircleOutlined, StopOutlined, TrophyOutlined,
...
const CryptoDetails = () => {
	...
	const stats = [
		...
		{ title: '24h Volume', value: `$ ${cryptoDetails?.["24hVolume"] && millify(cryptoDetails?.["24hVolume"])}`, icon: <DollarCircleOutlined /> },
	...
	return (
		<Col className='coin-detail-container'>
			...
			<LineChart
				...
				currentPrice={millify(cryptoDetails.price, {precision: 2})}
